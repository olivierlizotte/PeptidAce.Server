...
namespace Afinity
{
    ...
    /// </summary>
    public class TrinityMainAlchemy
    {
        /// <summary>
        ...
        /// </summary>
        public static ConSolAlchemy Sol;
        ...
        static void MainAlchemy(string[] args)
        {
            //Start SOL

            //Console <controller>
            Sol = new ConSolAlchemy();// = new vsConSOLe(new UpdateMethod(UpdateMethodHandler));                        
            string command = "";
...
//            Trinity.Methods.RawRtExtractor.FromFolderToCSV(@"G:\Thibault\-=Proteomics_Raw_Data=-\Tyers_ProhitsStorage\QEXACTIVE\Cdc34-Ubi\SEP12_2013\DSS\PeptidesMaps\100000\inter");
                ...
                if (user != null)
                {
                    ...
                    switch ((string)obj.Type)
                    {
                        ...
                        case "Menu":
                            ...
                            break;
                        case "Command":
                            if (Sol.GetConSolUser(context) != null)
                                Execute(obj.Command.Value, context);
                            else
                                SendError("You must log in if you want to send commands to the Trinity Server", context);
        ...
        public static void OnDisconnect(UserContext context)
        {
            try
            {
                ...
                ConSolUserAlchemy userCS = Sol.RemoveUserConSol(context);//TODO pass name or context?
